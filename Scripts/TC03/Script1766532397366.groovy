...
//WebUI.click(findTestObject('Object Repository/Page_Broker Forex Terbesar Indonesia  MIFX/div_Sell'))
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Broker Forex Terbesar Indonesia  MIFX/div_Sell'), 10)
WebUI.click(findTestObject('Object Repository/Page_Broker Forex Terbesar Indonesia  MIFX/div_Sell'))
